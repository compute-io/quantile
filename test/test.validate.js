...
describe( 'validate', function tests() {
    ...
    it( 'should return an error if provided a sorted option which is not a boolean primitive', function test() {
		var values, err;
	...
	it( 'should return an error if provided a method option which is not an integer between 1 and 9', function test() {
		var values, err;
